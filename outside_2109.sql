...
--
-- Host: localhost:3306
-- Gegenereerd op: 24 sep 2016 om 16:05
-- Serverversie: 5.5.42
-- PHP-versie: 7.0.0
...
CREATE TABLE `inhoud` (
  ...
  `naam_fr` varchar(255) DEFAULT '',
  `naam_en` varchar(255) DEFAULT '',
  `inhoud_nl` text,
  `inhoud_fr` text,
  `inhoud_en` text,
  `afspraak_nl` varchar(255) NOT NULL,
  `afspraak_fr` varchar(255) NOT NULL,
  `afspraak_en` varchar(255) NOT NULL,
  `periode_nl` varchar(255) NOT NULL,
  `periode_fr` varchar(255) NOT NULL,
  `periode_en` varchar(255) NOT NULL,
  `prijsklasseId` int(11) DEFAULT NULL,
  `minAantal` int(11) NOT NULL,
  `duur_nl` varchar(255) NOT NULL,
  `duur_fr` varchar(255) NOT NULL,
  `duur_en` varchar(255) NOT NULL,
...
CREATE TABLE `inhoud_activiteit_categorie` (
  `id` int(11) NOT NULL,
  `activiteitId` int(11) NOT NULL,
...
CREATE TABLE `inhoud_activiteit_categorie_type` (
  `id` int(11) NOT NULL,
...
CREATE TABLE `inhoud_activiteit_duur` (
  `id` int(11) NOT NULL,
  `activiteitId` int(11) NOT NULL,
...
CREATE TABLE `inhoud_activiteit_duur_type` (
  `id` int(11) NOT NULL,
...
CREATE TABLE `inhoud_activiteit_locatie` (
  `id` int(11) NOT NULL,
  `activiteitId` int(11) NOT NULL,
...
CREATE TABLE `inhoud_activiteit_locatie_type` (
  `id` int(11) NOT NULL,
...
CREATE TABLE `inhoud_activiteit_prijsklasse_type` (
  `id` int(11) NOT NULL,
...
CREATE TABLE `inhoud_categorie_type` (
  `id` int(11) NOT NULL,
  `type` varchar(255) NOT NULL DEFAULT ''
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `inhoud_prijs` (
  `id` int(11) NOT NULL,
  `activiteitId` int(11) NOT NULL,
  `prijs` varchar(255) NOT NULL,
  `titel_nl` varchar(255) NOT NULL DEFAULT '',
  `titel_fr` varchar(255) NOT NULL,
  `titel_en` varchar(255) NOT NULL,
  `prijs_nl` varchar(255) NOT NULL,
  `prijs_fr` varchar(255) NOT NULL,
  `prijs_en` varchar(255) NOT NULL,
  `extra_nl` varchar(255) NOT NULL,
  `extra_fr` varchar(255) NOT NULL,
  `extra_en` varchar(255) NOT NULL,
...
INSERT INTO `inhoud_prijs` (`id`, `activiteitId`, `prijs`, `titel_nl`, `titel_fr`, `titel_en`, `prijs_nl`, `prijs_fr`, `prijs_en`, `extra_nl`, `extra_fr`, `extra_en`, `catering`, `typeId`) VALUES
(2, 39, '60', 'Prijs per persoon:', '', '0', '€10: Halve dag<br>€15: Volledige dag', '2-daagse', '2-daagse', 'All-in', '', '', 0, 1),
(4, 61, '10', 'Prijs per persoon:', '', '0', '€10', '', '', '', '', '', 0, 1),
(5, 89, '20', 'Prijs per persoon:', '', '0', '€20', '', '', '', '', '', 0, 1),
(6, 94, '35', 'Prijs per persoon:', '', '0', '€35: Volwassenen <br>€20: Kinderen tot 12 jaar', '', '', 'Halve dag', '', '', 0, 1),
(8, 94, '+ 35', 'Supplement:', '', '0', '+€35: Aperitief & hapjes + uitgebreide maaltijd + koffie', '', '', '', '', '', 1, 2),
(9, 124, '0', 'Prijs per persoon:', '', '0', '€15', '', '', '', '', '', 0, 1),
(10, 126, '0', 'Richtprijs:', '', '0', '€95 per persoon', '', '', '', '', '', 0, 1),
(11, 130, '0', 'Prijs per persoon:', '', '0', '€35', '', '', '', '', '', 0, 1),
(12, 133, '0', 'Prijs per persoon:', '', '0', '€35: Volwassenen</br>€25: Kinderen tot 12 jaar', '', '', '', '', '', 0, 1),
(14, 137, '0', 'Prijs per persoon:', '', '0', '€35 per persoon', '', '', '', '', '', 0, 1),
(15, 137, '0', 'Supplement:', '', '0', '+€15 pp: Mini GP', '', '', '', '', '', 0, 2),
(16, 140, '0', 'Prijs per persoon:', '', '0', '€35', '', '', '', '', '', 0, 1),
(17, 140, '0', 'Supplement:', '', '0', '+€15 pp: Hapjes & whiskeydegustaties', '', '', '', '', '', 0, 2),
(18, 157, '0', 'Prijs per persoon:', '', '0', '€10', '', '', '', '', '', 0, 1),
(19, 157, '0', 'Supplement per persoon:', '', '0', '+€10: High ropes</br>+€5: Death ride</br>+€5: Pamperpaal', '', '', '', '', '', 0, 2),
(22, 169, '0', 'Prijs per persoon:', '', '0', '€15', '', '', '', '', '', 0, 1),
(23, 169, '0', 'Supplement:', '', '0', '+€5 pp: Pamperpaal', '', '', '', '', '', 0, 2),
(24, 190, '0', 'Prijs per persoon:', '', '0', '€50', '', '', '', '', '', 0, 1),
(25, 190, '0', 'Supplement:', '', '0', '+€20 pp: BBQ', '', '', '', '', '', 1, 2),
(26, 194, '0', 'Prijs zonder monitor:', '', '0', '€15 pp: Halve dag</br>€20 pp: Volledige dag', '', '', '', '', '', 0, 1),
(27, 194, '0', 'Prijs met monitor:', '', '0', '€20 pp: Halve dag</br>€25 pp: Volledige dag', '', '', '', '', '', 0, 1),
(28, 204, '0', 'Prijs per persoon:', '', '0', '€50', '', '', '', '', '', 0, 1),
(29, 207, '0', 'Prijs per persoon:', '', '0', '€35 per persoon', '', '', '', '', '', 0, 1),
(30, 207, '0', 'Supplement:', '', '0', '+ apero & diner: €70 per persoon', '', '', '', '', '', 0, 2),
(31, 210, '0', 'Prijs per persoon:', '', '0', '€45', '', '', '', '', '', 0, 1),
(32, 210, '0', 'Supplement:', '', '0', 'Vanaf €20 pp: BBQ', '', '', '', '', '', 0, 2),
(33, 213, '0', 'Prijs per groep:', '', '0', 'Vanaf €3000', '', '', '', '', '', 0, 1),
(34, 216, '0', 'Prijs per persoon:', '', '0', '€45: met 1 muzikant</br>€50: met 2 muzikanten', '', '', '', '', '', 0, 1),
(37, 216, '0', 'Prijs per persoon:', '', '0', '€45: Met authentieke Zwitserse Postbus</br> +€625: Huur bus', '', '', '', '', '', 0, 1),
(38, 222, '0', 'Prijs scholen & jeugdgroepen -18 jaar:', '', '0', ' €75 pp (2-daagse)</br>€100 pp (3-daagse)', '', '', '', '', '', 0, 1),
(39, 222, '0', 'Prijs Volwassenen:', '', '0', '€100 pp (2-daagse)</br>€125 pp (3-daagse)', '', '', '', '', '', 0, 1),
(42, 225, '0', 'Prijs per persoon:', '', '0', '€25 (inclusief drank)', '', '', '', '', '', 0, 1),
(43, 225, '0', 'Supplement per persoon:', '', '0', '+€35: Aperitief, hapjes en afsluitende maaltijd', '', '', '', '', '', 0, 2),
(44, 228, '0', 'Prijs per persoon:', '', '0', '€25 (met 2 praktische proeven)', '', '', '', '', '', 0, 1),
(45, 228, '0', 'Supplement:', '', '0', '+€5 pp per extra praktische proef', '', '', '', '', '', 0, 2),
(46, 232, '0', 'Prijs per persoon:', '', '0', '€18: Just Play</br>€28: Play & Taste</br>€40: Play & Dine', '', '', '', '', '', 0, 1),
(49, 243, '0', 'Prijs per persoon:', '', '0', '€35', '', '', '', '', '', 0, 1),
(50, 246, '0', 'Prijs per persoon:', '', '0', '€20: Kinderen tot 12 jaar</br>€35: Volwassenen', '', '', '', '', '', 0, 1),
(52, 254, '0', 'Prijs pp zonder monitor:', '', '0', '€15: Halve dag</br>€20: Volledige dag', '', '', '', '', '', 0, 1),
(54, 275, '0', 'Prijs per persoon:', '', '0', '€25', '', '', '', '', '', 0, 1),
(55, 275, '0', 'Prijs scholen, jeugdgroepen & studenten:', '', '0', '€19.5: in de week</br>€22.5: in het weekend/vakantie', '', '', '', '', '', 0, 1),
(57, 283, '0', 'Prijs per persoon:', '', '0', '€45', '', '', '', '', '', 0, 1),
(58, 283, '0', 'Groepsformule:', '', '0', '€19 pp (minimum 15 deelnemers) ', '', '', '', '', '', 0, 1),
(59, 283, '0', 'Supplement:', '', '0', '+€1 pp: Persoonlijke verzekering', '', '', '', '', '', 0, 2),
(60, 297, '0', 'Prijs per persoon:', '', '0', '€15', '', '', '', '', '', 0, 1),
(61, 297, '0', 'Supplement per persoon:', '', '0', '+€5: Boogschieten</br>(half uur)', '', '', '', '', '', 0, 2),
(62, 314, '0', 'Prijs per persoon:', '', '0', '€15', '', '', '', '', '', 0, 1),
(63, 320, '0', 'Prijs groep:', '', '0', '€175: (1 uur, max 10 pers)</br>€245: (1.5 uur, max 15 pers)</br>€310: (2 uur, max 20 pers)', '', '', '', '', '', 0, 1),
(66, 329, '0', 'Prijs per persoon:', '', '0', '€20', '', '', '', '', '', 0, 1),
(67, 329, '0', 'Prijs scholen, jeugdgroepen & studenten:', '', '0', ' €15: In de week</br>€17.5: In het weekend/vakantie', '', '', '', '', '', 0, 1),
(69, 348, '0', 'Prijs per persoon:', '', '0', '€15', '', '', '', '', '', 0, 1),
(70, 374, '0', 'Prijs per persoon:', '', '0', '€35', '', '', '', '', '', 0, 1),
(71, 374, '0', 'Supplement per persoon:', '', '0', '+€25: Aansluitende maaltijd of BBQ', '', '', '', '', '', 1, 2),
(72, 405, '0', 'Prijs per persoon:', '', '0', '€25', '', '', '', '', '', 0, 1),
(73, 407, '0', 'Prijs per persoon:', '', '0', '€20: Beachsporten</br>€20: Teambuilding</br>€25: Rafting</br>€25: Mountainbike</br>€35: Go-cart', '', '', '', '', '', 0, 1),
(74, 407, '0', 'Supplement:', '', '0', 'Vanaf €20 pp: BBQ', '', '', '', '', '', 1, 2),
(78, 410, '0', 'Prijs per persoon:', '', '0', '€35', '', '', '', '', '', 0, 1),
(79, 412, '0', 'Richtprijs:', '', '0', 'Installatie en materiaal: vanaf 450€</br>Min. 2 begeleiders aan €30 per uur', '', '', '', '', '', 0, 1),
(80, 448, '0', 'Prijs per persoon:', '', '0', 'Afhankelijk van de activiteiten en het aantal personen.', '', '', '', '', '', 0, 1),
(81, 448, '0', 'Huur locatie:', '', '0', '€295', '', '', '', '', '', 0, 1),
(82, 521, '0', 'Prijs per leerling:', '', '0', '€10: Halve dag</br>€15: Volledige dag', '', '', '', '', '', 0, 1),
(84, 521, '0', 'Supplement per leerling:', '', '0', '+€3.5: quad/wakeboard</br>+€5: paintball/lasershooting', '', '', '', '', '', 0, 2),
(86, 558, '0', 'Prijs per leerling:', '', '0', '€10: Halve dag</br>€15: Volledige dag', '', '', '', '', '', 0, 1),
(88, 558, '0', 'Supplement per leerling:', '', '0', '+€3.5: Quad</br>+€5 Paintball/lasershooting</br>+€5 Weekend/vakantie', '', '', '', '', '', 0, 2),
(91, 605, '0', 'Prijs per persoon:', '', '0', '€20 (begeleiders gratis)', '', '', '', '', '', 0, 1),
(92, 613, '0', 'Prijs per persoon:', '', '0', '€15', '', '', '', '', '', 0, 1),
(93, 613, '0', 'Supplement per leerling:', '', '0', '+€3.5: Quad</br>+€5: Lasershooting', '', '', '', '', '', 0, 2),
(95, 613, '0', 'Verplaatsingskosten:', '', '0', '€0.7 per km (heen en terug vanuit Poperinge)', '', '', '', '', '', 0, 2),
(96, 637, '0', 'Prijs per leerling:', '', '0', '€60', '', '', '', '', '', 0, 1),
(97, 637, '0', 'Supplement per leerling:', '', '0', '+€3.5: Quad/wakeboarden</br>+€5: Paintball/lasershooting', '', '', '', '', '', 0, 2),
(99, 640, '0', 'Prijs per leerling:', '', '0', '€100: Lagere scholen</br>€105: Middelbare scholen', '', '', '', '', '', 0, 1),
(100, 640, '0', 'Supplement per leerling:', '', '0', '+€3.5: Quad/wakeboarden</br>+€5: Paintball/lasershooting', '', '', '', '', '', 0, 2),
(103, 644, '0', 'Prijs per leerling:', '', '0', '€165: Lagere scholen</br>€175: Middelbare scholen', '', '', '', '', '', 0, 1),
(105, 647, '0', 'Prijs per leerling:', '', '0', '€95: Lagere scholen</br>€100 Middelbare scholen', '', '', '', '', '', 0, 1),
(108, 653, '0', 'Prijs per leerling:', '', '0', '€60: 2 dagen</br>€100: 3 dagen', '', '', '', '', '', 0, 1),
(110, 664, '0', 'Prijs per persoon:', '', '0', 'Vanaf €60: 2-daagse', '', '', '', '', '', 0, 1),
(111, 679, '0', 'Prijs per persoon:', '', '0', 'Op aanvraag', '', '', '', '', '', 0, 1),
(112, 693, '0', 'Prijs per persoon:', '', '0', 'Zie onderstaande tabel', '', '', '', '', '', 0, 1),
(113, 698, '0', 'Prijs per persoon:', '', '0', 'Zie onderstaande tabel', '', '', '', '', '', 0, 1),
(114, 701, '0', 'Huurprijs per dag:', '', '0', '€295', '', '', '', '', '', 0, 1),
(115, 701, '0', 'Prijs overnachten:', '', '0', '€25 pp per nacht', '', '', '', '', '', 0, 1),
(116, 704, '0', 'Prijs per persoon:', '', '0', '€20 per nacht', '', '', '', '', '', 0, 1),
(117, 897, '0', 'Prijs per persoon:', '', '0', '€25:  (min 15 personen)</br>€30: (min 10 personen)', '', '', '', '', '', 0, 1),
(119, 897, '0', 'Huren zonder monitor:', '', '0', '€25 per stuk', '', '', '', '', '', 0, 1),
(120, 897, '0', 'Verplaatsingskost bij levering:', '', '0', '€0.7 per km', '', '', '', '', '', 0, 2),
(121, 417, '0', 'Prijs per persoon:', '', '0', '€25: Kinderen tot 12 jaar</br>€35: Volwassenen', '', '', '', '', '', 0, 1),
(124, 462, '0', 'Prijs per persoon:', '', '0', '€20 (1,5 uur activiteit + drankje + pannenkoeken)', '', '', '', '', '', 0, 1),
(125, 462, '0', 'High ropes 4 kids:', '', '0', '€17.5 per persoon (enkel bij high ropes, vanaf 15 pers)', '', '', '', '', '', 0, 1),
(126, 462, '0', 'Combinatie 2 activiteiten:', '', '0', '€30 per persoon (duur activiteiten: 3 uur)', '', '', '', '', '', 0, 1),
(127, 485, '0', 'Prijs per persoon:', '', '0', 'Afhankelijk van de keuze van de activiteiten', '', '', '', '', '', 0, 1),
(128, 103, '0', 'Prijs per persoon:', '', '0', '€25: Kinderen tot 12 jaar</br>€35: Volwassenen', '', '', '', '', '', 0, 1),
(130, 194, '0', 'Prijs met Breughelbuffet:', '', '0', '€35: Kinderen tot 12 jaar</br>€60: Volwassenen', '', '', '', '', '', 0, 1),
(132, 116, '0', 'Prijs per persoon:', '', '0', '€15 per persoon', '', '', '', '', '', 0, 1),
(133, 254, '0', 'Prijs pp met monitor:', '', '0', '€20: Halve dag</br>€25: Volledige dag', '', '', '', '', '', 0, 1),
(134, 412, '0', 'Indien nodig:', '', '0', 'Stelling vanaf €200', '', '', '', '', '', 0, 2),
(135, 39, '60', 'Prijs pp meerdaagse:', '', '0', '€60: 2-daagse</br>€90: 3-daagse', '2-daagse', '2-daagse', 'All-in', '', '', 0, 1),
(136, 505, '', 'Prijs per persoon', '', '0', 'Vanaf €65', '', '', '', '', '', 0, 1),
(138, 485, '', 'Supplement', '', '', '€200: Stripact', '', '', '', '', '', 0, 2);
...
CREATE TABLE `inhoud_prijs_type` (
  `id` int(11) NOT NULL,
...
ALTER TABLE `inhoud`
  ADD PRIMARY KEY (`id`),
  ADD KEY `prijsklasseId` (`prijsklasseId`),
