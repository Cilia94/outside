...
--
-- Host: localhost:3306
-- Gegenereerd op: 26 okt 2016 om 18:25
-- Serverversie: 5.5.42
-- PHP-versie: 7.0.0
...
CREATE TABLE `inhoud_activiteit_categorie_type` (
  ...
  `inhoud_nl` text NOT NULL,
  `inhoud_fr` text NOT NULL,
  `inhoud_en` text NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `inhoud_activiteit_categorie_type` (`id`, `type`, `inhoud_nl`, `inhoud_fr`, `inhoud_en`) VALUES
(1, 'outdoor-adventure', '', '', ''),
(2, 'easy-leisure', '', '', ''),
(3, 'outdoor-pakket', '', '', ''),
(4, 'jeugdgroep', '<header>Jeugddiensten, sportclubs, verenigingen & jeugdgroepen -18 jaar </header>\r\n<p>\r\nOns Outdoorcentrum gelegen op de top van de Rodeberg en het Adventure Park in Poperinge zijn dé toplocaties voor avontuurlijke sportdagen.\r\n\r\nWe bieden er een zeer ruim pakket van avontuurlijke sporten aan. Alle jeugddiensten, sportdiensten, jeugdgroepen & -verenigingen (-18 jaar) kunnen er terecht voor een spectaculaire outdoorsportdag aan een zeer scherpe prijs.\r\n\r\nU kan zelf kiezen welke sporten u in het programma wenst op te nemen. Al deze sporten worden begeleid door monitoren van Outside en ook de volledige organisatie wordt door Outside verzorgd.\r\n</p>', '', '');
...
(6, 94, '35', 'Prijs per persoon:', '', '0', '€40: Volwassenen </br>€20: Kinderen tot 12 jaar', '', '', 'Halve dag', '', '', 0, 1),
...
(52, 254, '0', 'Prijs pp zonder monitor:', '', '0', '€20: Halve dag</br>€25: Volledige dag', '', '', '', '', '', 0, 1),
...
(58, 283, '0', 'Groepsformule:', '', '0', '€20 pp (minimum 15 deelnemers) ', '', '', '', '', '', 0, 1),
...
(128, 103, '0', 'Prijs per persoon:', '', '0', '€25: Kinderen tot 12 jaar</br>€40: Volwassenen', '', '', '', '', '', 0, 1),
...
(133, 254, '0', 'Prijs met begeleider:', '', '0', '€35 per uur extra', '', '', '', '', '', 0, 2),
...
(139, 898, '', 'Prijs per persoon:', '', '', '€25', '', '', '', '', '', 0, 1);
